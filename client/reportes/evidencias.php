...
<form method="post" id="form_adicional" enctype="multipart/form-data">
  <table>
    ...
    <tr><td><input type="file" id="evi" name="evi" accept="application/pdf, .jpg, .png"></td></tr>
...
$('#form').on('submit', function(e) {
    ...
    .then(res => res.json())
    .then(data => { alert(data.message || JSON.stringify(data)); location.reload(); })
