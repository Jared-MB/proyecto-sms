...
if ($totalRows_evia == 0) { ?> 
 ...
 <?php   } else { 
    do { 
        $href="../reportes/".$row_evia['RUTEVI'].$row_evia['FILEVI'];
        $pos = strpos($href,".pdf");
         if ($pos == false){ ?>
 ...
 <?php }
     ...
     <form method="post" id="form"  action="query/alta_evi.php" name="form" enctype="multipart/form-data">
        ...
        <input type="hidden" id="tip" name="tip"  value="FISICA" >
            ...
            <tr><td> <b></b><input type="file" id="evi" name="evi"  accept=".jpg, .png">  </td> </tr>
              <tr><td></tr></td>
...
<div style="margin-top:10em;">
  <br>
<b>Nota:</b>Tamaño maximo por archivo 10MB <br>
<b>Importante:</b>En caso de que se suba alguna foto por error favor de contactar al administrador por medio de este correo 'h.teo@hotmail.com'.
</div>
