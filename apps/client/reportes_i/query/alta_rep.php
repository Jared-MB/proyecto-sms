...
$insertSQL = sprintf("INSERT INTO REP (IDEREP,CONREP,FECEVE,FECREP,FREREP,OBSREP,LUGREP,PERREP,CANREP) VALUES ($iderep,'$confidencial', '$fecsus', '$fecha1', '$freeve','$obs', '$lugsus','$emp',0)");
$Result1=mysqli_query($conex, $insertSQL) or die (mysqli_error($conex));
//header("Location:../index.php");
 
 include("correo_not.php");	
