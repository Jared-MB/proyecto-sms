		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out5 =
					...
					"'>" +
					cate +
					"</option><option value='NATURAL'>NATURAL</option><option value='TECNICO'>TECNICO</option><option value='ECONOMICO'>ECONOMICO</option> </select>";
				out6 =
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out3 +=
					...
					"'/></td>";
				out4 +=
					"<td>Observaciones:</td><td> <input type='text' id='obs_e' name='obs_e' value='" +
					array[i].OBSREP +
					"'/></td>";
				out5 +=
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<tr><td width='200px'><b>Fecha del reporte:</b></td><td width='500px'>" +
					fecrep +
					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Fecha del suceso:</b>&nbsp;&nbsp;&nbsp;" +
					feceve +
					"</td></tr><tr><td><b>Lugar del suceso:</b></td><td>" +
					array[i].NOMLUG +
					"</td></tr><tr><td><b>Factor:</b></td><td>" +
					array[i].TIPFAC +
					"</td></tr><tr><td><b>Causa especifica:</b></td><td>" +
					array[i].TIPCAU +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				var fecrep = formato(array[i].FECREP);
				out +=
					"<tr><td><b>Fecha del reporte: </b><br>" +
					fecrep +
					"</td><td><b>Fecha del suceso: </b><br>" +
					feceve +
					"</td><td><b>Lugar del suceso: </b><br>" +
					array[i].NOMLUG +
					"</td><td><b>Frecuencia: </b><br>" +
					array[i].FREREP +
					"</td></tr><tr><td><b>Factor: </b><br>" +
					array[i].TIPFAC +
					"</td><td><b>Causa especifica: </b><br>" +
					array[i].TIPCAU +
					"</td><td><b>Observaciones: </b><br>" +
					array[i].OBSREP +
					"</td></tr>";
			}
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out +=
					...
					"</td><td><b>Email:<br> </b>" +
					array[i].EMAEMP +
					"</td><td><b>Celular:<br> </b>" +
					array[i].CELEMP +
					"/" +
					array[i].CEL2EMP +
					"</td><td><b>Telefono(s) Oficina:<br> </b>" +
					array[i].TELOFIEMP +
					"/" +
					array[i].TELOFI2EMP +
					" Ext:" +
					array[i].EXTEMP +
					"</td><td><b>Coordinación:<br> </b>" +
					array[i].NOMCAR +
					" / " +
					array[i].NOMCOO +
					"</td></tr>";
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out +=
					...
					array[i].GENPEL +
					"</td><td><b>Condición:<br> </b>" +
					array[i].CONPEL +
					"</td><td><b>Objeto:<br> </b>" +
					array[i].OBJPEL +
					"</td><td><b>Actividad:<br> </b>" +
					array[i].ACTPEL +
					"</td></tr>";
			}
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					out +=
						...
						";'><b> " +
						riesgo +
						"<b></td><td align='center'><a href='../gestion/propuestas.php?IDEREP=" +
						y +
						"&IDERIE=" +
						iderie +
						"'><IMG height='25px'  SRC='../imagenes/prop.png'></a></td>" +
						"<td align='center'><a href='../gestion/query/baja_com.php?IDERIE=" +
						iderie +
						"&IDEREP=" +
						y +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				out +=
					"<thead style='color: #fff;'><tr><td style='background:#2672EC;'>NOMBRE</td><td style='background:#2672EC;'>CARGO / COORDINACIÓN</td><td style='background:#2672EC;'></td></tr></thead>";
				for (i = 0; i < array.length; i++) {
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<tr><td><b>Peligro genérico:<br> </b>" +
					array[i].GENPEL +
					"</td><td><b>Componente especifico:<br> </b>" +
					array[i].CESPRIE +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out =
					"<input type='text' id='emsm' name='emsm' value='" +
					array[i].MSMMON +
					"'/>";
				out2 =
					"<input type='text' id='epsm' name='epsm' value='" +
					array[i].PSMMON +
					"'/>";
				out3 =
					"<input type='text' id='epso' name='epso' value='" +
					array[i].PSOMON +
					"'/>";
				out4 =
