...
<div class="barra_login">
	...
	<?php } ?>
	<div class="loginitem" align="right"><a href="ajustes/cuenta"><?php echo ($_SESSION["nombre"]); ?></a>
		<br><a href="conex/logout.php">Cerrar sesión</a>
	</div>
...
<?php $fondo = isset($_SESSION['fondo']) ? $_SESSION['fondo'] : 'img/fondo-azul-exagonos-fotorecurso.jpg';  ?>
...
<body BACKGROUND="<?php echo "ajustes/visual/" . $fondo; ?>">
	...
	<div class="container js-isotope" data-isotope-options="{ " itemSelector": ".item" , "layoutMod" : "fitRows" }">
		...
		<div class="item item-blue"><a class="post-title" href="reportes"><IMG height="100px" SRC="imagenes/menu_rep.png">Reportes</a></div>
		<div class="item item-teal"><a class="post-title" href="gestion"><IMG height="100px" SRC="imagenes/menu_ges.png"><br>Gesti&#243;n de reportes</a></div>
		<div class="item item-teal"><a class="post-title" href="documentos"><IMG height="100px" SRC="imagenes/documento.png"><br>Gesti&#243;n de documentos</a></div>
		<div class="item item-green2"><a class="post-title" href="juntas"><IMG height="100px" SRC="imagenes/menu_inv.png"><br>Juntas de Control</a></div>
		<div class="item item-red"><a class="post-title" href="monitoreo"><IMG height="100px" SRC="imagenes/menu_mon.png">Monitoreo de medidas</a></div>

		<div class="item item-yellow"><a class="post-title" href="tendencias"><IMG height="100px" SRC="imagenes/menu_ten.png">Tendencia</a></div>
		<!--
<div class="item item-darkpurple"><a class="post-title" href="indicadores.html"><IMG height="100px" SRC="imagenes/menu_ind.png">Indicadores de seguridad</a></div>-->
		...
		$i = mysqli_query($conex, $query_i) or die(mysqli_error($conex));
		...
		$r = mysqli_query($conex, $query_r) or die(mysqli_error($conex));
