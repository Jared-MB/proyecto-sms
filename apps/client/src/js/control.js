...
$(document).ready(function () {
	$("#area").on("change", function () {
		if ($("#area").val() == "") {
			$("#emp").empty();
			$('<option selected="selected" value="">--ELEGIR--</option>').appendTo(
				"#emp",
			);
	...
	$("#area_res_asignar").on("change", function () {
		if ($("#area_res_asignar").val() == "") {
			...
			$("#emp_res_asignar").load(
				"query/nombre_get.php?area=" + $("#area_res_asignar").val(),
			);
		}
	});
	...
	$("#tac").on("click", function () {
		if ($("#tac").val() == "") {
			...
			$("#agregar_taxo").attr(
				"href",
				'javascript:openventana_var(".ventana_19",' +
					$("#tac").val() +
					',"IDETAC_NUEVO");',
			);
		}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			out +=
				...
				">" +
				cancelar +
				"</option><option value=0>NO</option><option value=1>SI</option>";
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out =
					"<input type='text' id='ide_gen_e' name='ide_gen_e' value='" +
					array[i].GENPEL +
					"'/>";
				out2 =
					"<input type='text' id='con_e' name='con_e' value='" +
					array[i].CONPEL +
					"'/>";
				out3 =
					"<input type='text' id='obj_e' name='obj_e' value='" +
					array[i].OBJPEL +
					"'/>";
				out4 =
					"<input type='text' id='act_e' name='act_e' value='" +
					array[i].ACTPEL +
					"'/>";
				out5 =
					"<select id='cat_e' name='cat_e'><option selected='selected' value='" +
					cate +
					"'>" +
					cate +
					"</option><option value='NATURAL'>NATURAL</option><option value='TÉCNICO'>TÉCNICO</option><option value='ECONÓMICO'>ECONÓMICO</option> </select>";
				out6 =
					"<select id='met_ide_e' name='met_ide_e'> <option selected='selected' value='" +
					meto +
					"'>" +
					meto +
					"</option> <option value='REACTIVO'>REACTIVO</option><option value='PROACTIVO'>PROACTIVO</option> </select>";
				out7 =
					"<select id='rie_ope_e' name='rie_ope_e'><option selected='selected' value='" +
					ries +
					"'>" +
					ries +
					"</option><option value='SI'>SI</option><option value='NO'>NO</option></select>";
			}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				nomemp =
					array[i].NOMEMP + " " + array[i].APPEMP + " " + array[i].APMEMP;
				priv = array[i].PRISES;
				...
				out +=
					...
					"'>" +
					privilegio +
					"</option><option value='1'>ADMINISTRADOR</option><option value='2'>USUARIO SMS</option><option value='3'>DIFUSIÓN</option><option value='4'>USUARIO NORMAL</option>";
			}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<td>Confidencial:</td> <td> <select id='con_e' name='con_e'> <option selected='selected' value=" +
					conf +
					">" +
					sino +
					"</option><option value=1>SI</option> <option value=0>NO</option> </select></td>";
				out2 +=
					"<td>Fecha del suceso:</td><td> <input type='date' id='fecsus_e' name='fecsus_e' value='" +
					array[i].FECEVE +
					"'/></td>";
				out3 +=
					"<td>Fecha del reporte:</td><td> <input type='date' id='fecrep_e' name='fecrep_e' value='" +
					array[i].FECREP +
					"'/></td>";
				out4 +=
					"<td>Descripción del evento:</td><td> <textarea rows='4' cols='50' id='obs_e' name='obs_e'>" +
					array[i].OBSREP +
					"</textarea></td>";
				out5 +=
					"<td>Frecuencia del evento:</td><td> <select id='freeve_e' name='freeve_e'><option selected='selected' value='" +
					frec +
					"'>" +
					frec +
					"</option><option value='ES LA PRIMERA VEZ'>ES LA PRIMERA VEZ</option><option value='EXTREMADAMENTE IMPROBABLE'>EXTREMADAMENTE IMPROBABLE</option><option value='IMPROBABLE'>IMPROBABLE</option><option value='REMOTO'>REMOTO</option><option value='OCASIONAL'>OCASIONAL</option><option value='FRECUENTE'>FRECUENTE</option><option value='PERMANENTE'>PERMANENTE</option> </select></td>";
			}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<tr><td width='30%'><b>Lugar del suceso:</b></td><td width='70%'>" +
					array[i].NOMLUG +
					"</td></tr><tr><td><b>Factor:</b></td><td>" +
					array[i].TIPFAC +
					"</td></tr><tr><td><b>Causa específica:</b></td><td>" +
					array[i].TIPCAU +
					"</td></tr><tr><td><b>Frecuencia:</b></td><td>" +
					array[i].FREREP +
					"</td></tr><tr><td><b>Observaciones:</b></td><td>" +
					array[i].OBSREP +
					"</td></tr>";
			}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				var fecrep = formato(array[i].FECREP);
				out +=
					"<tr><td width='120px'><b>Fecha del reporte: </b></td><td>" +
					fecrep +
					"</td></tr><tr><td><b>Fecha del suceso: </b></td><td>" +
					feceve +
					"</td></tr><tr><td><b>Lugar del suceso: </b></td><td>" +
					array[i].NOMLUG +
					"</td></tr><tr><td><b>Frecuencia: </b></td><td>" +
					array[i].FREREP +
					"</td></tr><tr><td><b>Observaciones: </b></td><td>" +
...
function cargarti_emp(x) {
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out +=
					"<tr><td width='120px'><b>Nombre:</b></td><td width='auto'>" +
					array[i].NOMEMP +
					" " +
					array[i].APPEMP +
					" " +
					...
					array[i].EMAEMP +
					"</td></tr><tr><td ><b>Celular:</b></td><td>" +
					array[i].CELEMP +
					"/" +
					array[i].CEL2EMP +
					"</td></tr><tr><td><b>Telefono(s) Oficina:</b></td><td>" +
					array[i].TELOFIEMP +
					"/" +
					array[i].TELOFI2EMP +
					" Ext:" +
					array[i].EXTEMP +
					"</td></tr><tr><td><b>Coordinación: </b></td><td>" +
					array[i].NOMCAR +
					" / " +
					array[i].NOMCOO +
					"</td></tr>";
...
function cargarti_pel(x) {
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out +=
					"<tr><td><b>Peligro genérico: </b>" +
					array[i].GENPEL +
					"</td></tr><tr><td><b>Condición: </b>" +
					array[i].CONPEL +
					"</td></tr><tr><td><b>Objeto: </b>" +
					array[i].OBJPEL +
					"</td></tr><tr><td><b>Actividad: </b>" +
					array[i].ACTPEL +
					"</td></tr>";
			}
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					if (color_rev == "#ecde02") {
						color_fuente_rev = "#000";
					}
					if (riesgo_rev == "") {
						riesgo_rev = "SIN EVALUAR";
						color_fuente_rev = "#000";
					}
					out +=
						"<tr><td>" +
						...
						"</td><td>" +
						array[i].CONRIE +
						"</td><td style='text-align:center;color:white; background-color:" +
						color +
						";color:" +
						color_fuente +
						";'><b> " +
						...
						riesgo +
						"<b></td><td align='center'><a href=javascript:openventana_var('.ventana_9'," +
						iderie +
						",'IDERIE_PRO',8);><IMG height='30px' SRC='../imagenes/propuestas.png'></a></td><td align='center'><a href=javascript:openventana_var('.ventana_9_5'," +
						iderie +
						",'IDERIE_PRO',9);><IMG height='30px' SRC='../imagenes/icono_medida_mitigacion2.png'></a></td><td style='text-align:center;background-color:" +
						color_rev +
						";'><b><a style='color:" +
						color_fuente_rev +
						";' href=javascript:openventana_var('.ventana_14'," +
						iderie +
						",'IDRIEEVA');>" +
						riesgo_rev +
						"</a></b></td><td align='center'><a href=javascript:openventana_var('" +
						ventana +
						"'," +
						iderie +
						",'iderie_e',5);><IMG height='25px' SRC='../imagenes/edit.png'></a></td><td align='center'><a href='../gestion/query/baja_com.php?IDERIE=" +
						iderie +
						"&IDEREP=" +
						y +
						"'><IMG height='25px' title='Eliminar' SRC='../imagenes/eliminar.png'></td></tr>";
				}
			}
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				out +=
					"<thead style='color: #fff;'><tr><td style='background:#2672EC;'>NOMBRE</td><td style='background:#2672EC;'>CARGO / COORDINACIÓN</td><td align='center' style='background:#2672EC;'>NOTIFICAR</td><td style='background:#2672EC;'></td></tr></thead>";
				for (i = 0; i < array.length; i++) {
					...
					if (not == null) {
						out +=
							...
							" / " +
							array[i].NOMCOO +
							"</td><td align='center'><a href='query/correo_inv.php?ide=" +
							ideinv +
							"&IDEREP=" +
							iderep +
							"'><IMG height='25px' title='Notificar' SRC='../imagenes/correo.png'></td><td align='center'><a href='../gestion/query/baja_inv.php?IDEPRO=" +
							y +
							"&IDEREP=" +
							iderep +
							"&IDEINV=" +
						...
						out +=
							...
							" / " +
							array[i].NOMCOO +
							"</td><td align='center'>Notificado el: " +
							not +
							" </td><td align='center'><a href='../gestion/query/baja_inv.php?IDERIE=" +
							y +
							"&IDEREP=" +
							iderep +
							"&IDEINV=" +
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					...
					" / " +
					array[i].NOMCOO +
					"</td><td align='center'><a href='../gestion/query/baja_res.php?IDERIE=" +
					rie +
					"&IDEREP=" +
					rep +
					"&IDEINV=" +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<tr><td><b>Peligro genérico:<br> </b>" +
					array[i].GENPEL +
					"</td><td><b>Componente específico:<br> </b>" +
					array[i].CESPRIE +
					"</td><td><b>Consecuencia:<br> </b>" +
					array[i].CONRIE +
					"</td><td style='width:150px;text-align:center;'><b>Periodo de tolerabilidad:<br> </b><div style='background-color:" +
					color +
					";color:" +
					color_fuente +
					";'><b>" +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					"<tr><td style='background-color: #008299;color:#fff;' width='auto' height='10px' align='left'>Comentado el " +
					feccom +
					"</td></tr><tr><td style='border: 1px solid #ddd; background-color: #ebf1f1;'  align='left' width='80px'>" +
					array[i].NOMCOM +
					"</td></tr><tr><td style='border: 1px solid #ddd;'>" +
					array[i].COMCOM +
					"</td></tr>";
			}
...
function cargar_pro_inicial(idpro) {
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out +=
					"<tr><td><b>Propuesta inicial:</b></td></tr><tr><td>" +
					array[i].PRIPRO +
					"</td></tr>";
			}
...
function cargar_editar_monitoreo(idrep) {
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
             ...
             */
				out4 =
					"<input type='text' id='edif' name='edif' value='" +
					array[i].DIFMON +
					"'/>";
				out5 =
					"<input type='text' id='emit' name='emit' value='" +
					array[i].MITMON +
					"'/>";
				out6 =
					"<select id='eest' name='eest'> <option selected='selected' value='" +
					array[i].ESTMON +
					"'>" +
					array[i].ESTMON +
					"</option> <option value='ABIERTO'>ABIERTO</option><option value='CERRADO'>CERRADO</option> </select>";
				if (fecha_cierre == "00/00/0000") {
					out7 = "Sin fecha de cierre";
				} else {
					if (array[i].ESTMON == "ABIERTO") {
						out7 = "Ultima fecha de cierre: " + fecha_cierre;
					} else {
						out7 = fecha_cierre;
					}
				}
...
function cargar_editar_riesgo(idrie) {
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				out =
					"<input type='text' id='com' name='com' value='" +
					array[i].CESPRIE +
					"'/>";
				out2 =
				...
				out4 =
					...
					"'>" +
					array[i].PROBRIE +
					"</option><option value=1>1</option><option value=2>2</option><option value=3>3</option><option value=4>4</option><option value=5>5</option>";
				out5 =
					"<option selected='selected' value='" +
					array[i].GRARIE +
					"'>" +
					array[i].GRARIE +
					"</option><option value='A'>A</option><option value='B'>B</option><option value='C'>C</option><option value='D'>D</option><option value='E'>E</option>";
				out6 =
					"<input type='hidden' id='iderep5' name='iderep5' value='" +
					array[i].REPPEL +
					"'/>";
			}
			...
			xmlhttp.onreadystatechange = function () {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					if (n_involucrados == n_participantes) {
						document.getElementById(idepro).innerHTML =
							"<a href=javascript:openventana_var('.ventana_5'," +
							idepro +
							",'pro',3); >Concluida</a>";
					} else {
						document.getElementById(idepro).innerHTML =
							"<a href=javascript:openventana_var('.ventana_5'," +
							idepro +
							",'pro',3); ><IMG height='25px' title='Reunión en curso' SRC='../imagenes/comentar_sin_revisar.png'></a>";
					}
				}
			};
			xmlhttp.open("GET", url, true);
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for (i = 0; i < array.length; i++) {
				...
				out +=
					...
					"</td><td><b>Consecuencia:<br> </b>" +
					array[i].CONRIE +
					"</td><td style='width:150px;text-align:center;'><b>Indice de riesgo:<br>";
				if (riesgo == "") {
					riesgo = "SIN EVALUAR";
					out +=
						"</b><div><b><a href=javascript:openventana_var('.ventana_8'," +
						y +
						",'IDRIEEVA'); >" +
						riesgo +
						"</a></b></div></td></tr>";
					...
					out +=
						...
						";color:" +
						color_fuente +
						";'><b><a href=javascript:openventana_var('.ventana_8'," +
						y +
						",'IDRIEEVA');>" +
						riesgo +
						"</a></b></div></td></tr>";
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					out +=
						"<tr><td style='border-bottom: 1px solid #000;width:400px;'>" +
						array[i].PRIPRO +
						"</td><td style='border-bottom: 1px solid #000;width:100px;' align='center'><a href=javascript:openventana_var('.ventana_7'," +
						idepro +
						",'IDEPRO_INV',7);><IMG height='25px'  SRC='../imagenes/empleados.jpg'></a></td><td align='center' style='border-bottom: 1px solid #000;width:30px;'><a href='../gestion/query/baja_pro.php?IDEPRO=" +
						idepro +
						"&IDERIE=" +
						y +
						"&IDEREP=" +
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					out +=
						"<tr><td style='border-bottom: 1px solid #000;width:300px;'><a  style='color:black;' href=javascript:openventana_var('.ventana_12'," +
						idepro +
						",'IDPRO',2);>" +
						array[i].DESPRO +
						"</a></td><td style='border-bottom: 1px solid #000;width:80px;'><a  style='color:black;' href=javascript:openventana_var('.ventana_22'," +
						idepro +
						",'IDEPRO22',2);>" +
						array[i].ESTPRO +
						"</a></td><td align='center' style='border-bottom: 1px solid #000;' width='10%'><a href='../gestion/query/baja_pro.php?IDEPRO=" +
						idepro +
						"&IDERIE=" +
						y +
						"&IDEREP=" +
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					if (fecnot == null) {
						boton_correo =
							"<td align='center'><a href='query/correo_res.php?ide=" +
							ideres +
							"&IDERIE=" +
							iderie +
							"&IDEREP=" +
					...
					out +=
						...
						"</td>" +
						boton_correo +
						"<td align='center'><a href='../gestion/query/baja_res.php?IDERIE=" +
						iderie +
						"&IDEREP=" +
						iderep +
						"&IDERES=" +
	...
	xmlhttp.onreadystatechange = function () {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (array.length == 0) {
				...
				out +=
					"<thead><tr><td><b>Fecha de anexado&nbsp;</b></td><td><b> Nombre del documento</b></td><td></td><td></td></tr></thead>";
				for (i = 0; i < array.length; i++) {
					...
					if (fecverdoc == "00/00/0000") {
						...
						out +=
							...
							"'>" +
							array[i].NOMDOC +
							"</a></td><td><input type='submit' value='Aprobar' class='boton' onclick=location.href='query/validar_doc.php?IDEDOC=" +
							idedoc +
							"'; /></td>" +
							"<td><input type='submit' value='Rechazar' class='boton' onclick=openventana_varx('.ventana_2'," +
							idedoc +
							",'iddoc'); /></td><td><a href='query/baja_doc.php?idedoc=" +
							idedoc +
							"&dirdoc=" +
							dirdoc +
							"'><IMG title='Eliminar documento' height='25px' SRC='../imagenes/eliminar.png'></a></td></tr>";
					} else {
						var res = "";
						if (array[i].VERDOC != "APROBADO") {
							res = "RECHAZADO";
						} else {
							res = "APROBADO";
						}
			...
			if (array.length == 0) {
				...
				for (i = 0; i < array.length; i++) {
					...
					out +=
						"<tr><td style='border-bottom: 1px solid #000;width:400px;'>" +
						despro +
						"</td><td style='border-bottom: 1px solid #000;width:100px;' align='center'>" +
						respro +
						"</td><td align='center' style='border-bottom: 1px solid #000;width:30px;'>" +
						tiepro +
						"</td><td align='center' style='border-bottom: 1px solid #000;width:30px;'><a style='color:black;' href=javascript:openventana_var('.ventana_3'," +
						idepro +
						",'IDEPRO3'); >" +
						estpro +
						"</a></td><td align='center' style='border-bottom: 1px solid #000;width:30px;'><a href='query/baja_pro.php?IDEPRO=" +
						idepro +
						"&IDETEM=" +
						idetem +
						"' ><IMG height='20px' SRC='../imagenes/eliminar.png'></a></td></tr>";
				}
			}
			document.getElementById("propuestas").innerHTML = out;
		}
