                        ...
                        <div class="tabla reportes">
                            ...
                            <table id="tabla_ges">
                                ...
                                do {
                                    ...
                                    $mes = date("M", strtotime($fecrep));
                                    $mes = mb_strtoupper($mes);
                                ?>

                                    <tbody>
                                        <tr>
                                            <td style="color:#fff; background-color:#2672EC"><?php echo ($mes); ?></td>
                                            <td align="center"><?php echo ($iderep); ?></td>
                                            <td align="center"><?php echo ($fecrep); ?></td>
                                            <td align="center"><?php echo $fecpel; ?></td>
                                            <td align="center"><?php echo ($row_pel['NOMGESPEL']); ?></td>
