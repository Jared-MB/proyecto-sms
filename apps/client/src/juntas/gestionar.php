...
if($theme==1){include("menu_gestionar.html");}else{include("menus_2/menu_gestionar.html");}
 }
...
?>
<tr>
<td style="font-size:12px;"><?php echo $destem; ?></td><td width="10%" align="center"><a href="javascript:openventana_var('.ventana_1',<?php echo($idetem); ?>,'IDETEM2','j2');"><img src="../imagenes/empleados.jpg" width="35px" ></a></td>
<td align="center" width="10%"><a href="query/baja_tem.php?IDETEM=<?php echo $idetem;?>&IDEJUN=<?php echo $idejun;?>" ><IMG height="20px" SRC="../imagenes/eliminar.png"></a></td>
</tr>
          ...
          <?php 
             ...
             <?php }?>
            <form method="get"  action="javascript:openventana('.ventana');"><button class="boton" type="submit">AGREGAR TEMA</button></form>
          <?php  } ?>     
